...
class MQTT:
    ...
    sub_topics = [("620155793_pub", 0), ("620155793", 0), ("620155793_sub", 0)] #  A list of tuples of (topic, qos). Both topic and qos must be present in the tuple.
    ...
    def __init__(self,mongo):
        ...
        self.client.message_callback_add("620155793", self.update)
        self.client.message_callback_add("620155793_pub", self.toggle)
